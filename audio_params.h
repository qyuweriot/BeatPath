...
// BGM ミックス振幅
// ------------------------------------------------------------
static constexpr float KICK_AMP_DOWN  = 1.0f;   // 小節頭キック
static constexpr float KICK_AMP_WEAK  = 0.8f;   // その他の拍
static constexpr float BASS_AMP_ROOT  = 1.0f;
static constexpr float BASS_AMP_FIFTH = 0.8f;
static constexpr float PAD_AMP        = 1.0f;
...
static const TileSound TILE_SOUNDS[T_COUNT] = {
    /* T_EMPTY   */ {},
    /* T_TURN_R  */ { V_RIDE,    C4, 1.0f },
    /* T_TURN_L  */ { V_SNARE,   E4, 1.0f },
    /* T_SPLIT   */ { V_MARIMBA, E5, 1.0f },
    /* T_SPLIT3  */ { V_MARIMBA, G5, 1.0f },
    /* T_SPEED2  */ { V_TOM,     G3, 0.9f },
    /* T_SLOW    */ { V_TOM,     D2, 0.9f },
    /* T_STOP    */ { V_TOM,     G3, 0.7f },
    /* T_PAINT_R */ { V_BELL,    C5, 0.8f },
    /* T_PAINT_B */ { V_BELL,    E5, 0.8f },
    /* T_PAINT_Y */ { V_BELL,    G5, 0.8f },
};
...
static const Sound SND_WALL_BREAK     = { V_SNARE,            0,    1.0f };
static const Sound SND_WARP           = { V_SWEEP, SFX_SWEEP_START, 1.0f };
static const Sound SND_GOAL_WRONG     = { V_CLICK,           C3,    0.5f };

// ゴール到達 (gi % 4 でインデックス)
static const double GOAL_FREQ[4]  = { C5, E5, G5, A5 };
